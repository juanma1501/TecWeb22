...
/* Especifica las caracter?sticas y funciones particulares de un alfil. */
public class Alfil extends Pieza {
	
	
	public Alfil(int nId, char cColor, int nPosFila, int nPosColumna) {
	...
	public int esValido(Pieza [][] aapTablero, int nFilaOrigen, int nColumnaOrigen, int nFilaDestino, int nColumnaDestino) {
		int nValido;
		if (Math.abs(nFilaOrigen-nFilaDestino)==Math.abs(nColumnaOrigen-nColumnaDestino)) {
